    ...
    <header className="bg-black shadow-lg h-24 hidden md:flex">
      ...
      <nav className="hidden xl:contents">
        <ul className="flex items-center mr-4 lg:mr-6 xl:mr-8">
          ...
          <li className="p-1">
            <a href="#" className="rounded-full border border-white aspect-square w-12 h-12 overflow-hidden flex items-center justify-center hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
              <img src="/linked.svg" alt="Facebook" className="w-full h-full object-contain" />
            </a>
          </li>
      ...
      <div className="flex items-center px-4 lg:px-6 xl:px-8">
        <a href="#" className="mr-4 lg:mr-6 xl:mr-8 text-white">
