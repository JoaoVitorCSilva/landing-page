    ...
    <div className="container mx-auto my-5 mb-20">
      <div className=" relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-72 mx-2">
        ...
        <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
          <div className="p-8 md:pr-18 md:pl-14 md:py-12 mx-2 md:mx-0 h-full bg-transparent rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none">
            <h4 className="hidden md:block text-xl text-white relative z-20">{titulo}</h4>
            <h3 className="hidden md:block font-bold text-2xl text-white">{subtitulo}</h3>
            <p className="text-white text-justify drop-shadow-lg">{texto}</p>
          </div>
        </div>
      </div>
    </div>
